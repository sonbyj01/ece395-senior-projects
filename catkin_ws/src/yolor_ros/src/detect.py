...
def detect(data, save_img=False):
    ...
    #--- removed for loop because this will be a single image from ros topic
    #--- adding from util.datasets into here
    vid_cap = None
    path = 'zed'
    try: 
        im0s = bridge.imgmsg_to_cv2(data, 'bgr8')
    except CvBridgeError as e:
        print(e)
    
    img = letterbox(im0s, new_shape=imgsz, auto_size=64)[0]
